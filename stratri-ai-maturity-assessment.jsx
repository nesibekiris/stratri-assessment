...
export default function App() {
  ...
  function pick(lv) { setAns(p => ({ ...p, [dom.id]: { ...p[dom.id], [cQ]: lv } })); }
  function next() {
    ...
    return (
      <div style={pg}>
        <div style={{ maxWidth: 560, margin: "0 auto", padding: "56px 28px" }}>
          ...
          <button onClick={() => ok && setPhase("assessment")} disabled={!ok} style={{
      ...
      <div style={{ ...pg, overflowY: "auto" }}>
        <div style={{ maxWidth: 840, margin: "0 auto", padding: "52px 28px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 48 }}>
            ...
            <button onClick={() => { setPhase("welcome"); setAns({}); setCD(0); setCQ(0); }} style={{
